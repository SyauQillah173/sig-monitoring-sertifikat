...
<div class="grid gap-5 md:grid-cols-2">
    ...
    @include('cement.maintenance.certificates.shared-reference-field', ['name' => 'jenis_sertifikasi_reference_id', 'label' => 'Jenis Sertifikasi', 'type' => \App\Models\CementReferenceValue::TYPE_JENIS_SERTIFIKASI, 'value' => $certificate->jenis_sertifikasi_reference_id])
    @include('cement.maintenance.certificates.shared-reference-field', ['name' => 'lspro_reference_id', 'label' => 'LSPro', 'type' => \App\Models\CementReferenceValue::TYPE_LSPRO, 'value' => $certificate->lspro_reference_id])
