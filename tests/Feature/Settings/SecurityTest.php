...
class SecurityTest extends TestCase
{
    ...
    public function test_security_settings_page_can_be_rendered(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertSeeInOrder(['Two-factor authentication', 'Ganti Password']);
    }

    public function test_recently_authenticated_user_can_open_security_settings_without_extra_confirmation(): void
    {
        $user = User::factory()->create();
